...
export default function AdminCommunityPage() {
  ...
  async function restore(id: number) { try { await adminCommunityApi.postStatus({ id, status: 1 }); setMessage("帖子已恢复公开"); await load(); } catch (cause) { setError(cause instanceof CurmerceApiError ? cause.message : "帖子恢复失败"); } }
